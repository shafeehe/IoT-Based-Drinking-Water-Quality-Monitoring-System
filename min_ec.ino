...
Adafruit_SSD1306_EMULATOR display(SCREEN_WIDTH, SCREEN_HEIGHT, &Wire, -1);
...
const char* ssid =  "ecmini";     // replace with your wifi ssid and wpa2 key
const char* passwrd =  "1234";
